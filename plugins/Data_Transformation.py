...
## Get Data From csv -- change path with path location or machine
path = '/data/'
read_economy = pd.read_csv('data/economy.csv')
read_business = pd.read_csv('data/business.csv')
read_cleandata = pd.read_csv('data/Clean_Dataset.csv')
...
## Data Transform
read_economy['class'] = 'Economy'
read_business['class'] = 'Business'
